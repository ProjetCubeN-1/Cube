      ...
      <div class="row">
          <div class="col-lg-12 mt-5" style="background-color: rgba(255, 255, 255, 0.75); height:38em">
              <form method="post" action="/login/create">
                  ...
                  <input type="password" required="true" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[-+!*$@%_])([-+!*$@%_\w]{8,15})$" placeholder="Au moins 8 caractères, un chiffre, une lettre majuscule et une minuscule" title="Au moins 8 caractères, un chiffre, une lettre majuscule et une minuscule" id="pass" name="pass" class="form-control mt-2">

                  <label for="confmdp">Confirmez le mot de passe*</label>
                  <input type="password" require="true" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[-+!*$@%_])([-+!*$@%_\w]{8,15})$" placeholder="Au moins 8 caractères, un chiffre, une lettre majuscule et une minuscule" title="Au moins 8 caractères, un chiffre, une lettre majuscule et une minuscule" id="confmdp" name="confmdp" class="form-control mt-2">
